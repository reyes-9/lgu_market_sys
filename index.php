...
<body class="body light">
    ...
    <div class="content-wrapper text-light">
        ...
        <div class="button-container">
            <a class="btn btn-custom disabled-link" href="/lgu_market_sys/pages/feedback">Feedback Services</a>
            <a class="btn btn-custom" href="/lgu_market_sys/pages/portal">Vendor Portal</a>
            <a class="btn btn-custom disabled-link" href="/lgu_market_sys/pages/map">Vendor Mapping</a>
        </div>
    </div>
