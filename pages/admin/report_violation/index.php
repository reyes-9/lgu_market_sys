...
<body class="body light">
    ...
    <div class="text-start m-3 p-3 title d-flex align-items-center">
        ...
        <div>
            <h4 class="m-0">Admin - Report Violations</h4>
            <p class="text-muted mb-0">Report and log violations committed by vendors to maintain order in the market.</p>
        ...
        <div class="ms-auto me-5">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="http://localhost/lgu_market_sys/pages/admin/violation/">Violations </a></li>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-center align-items-center mb-4">
            <div class="container">
                <h4 class="fw-bold">Report Violation</h4>
